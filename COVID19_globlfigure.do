...
drop tot_pop
gen mmr=0
reg log_positive t_Myanmar t_Singapore
...
drop tot_pop
gen mmr=0
reg log_d d_Myanmar d_Singapore
...
&&&
preserve 
lab var n_Myanmar "Positive cases"
lab var d_Myanmar "Death cases"
twoway (line n_Myanmar datevar) (line d_Myanmar datevar) ,name(MMR,replace)
restore

  (line new_Brunei datevar) (line new_Timor datevar) /// 
 (line new_Malaysia datevar) (line new_Singapore datevar)  ///
(line new_Vietnam datevar)(line new_Indonesia datevar) (line new_Philippines datevar)



twoway (line new_Myanmar datevar) (line new_Thailand datevar) ///
  (line new_Laos datevar) (line new_Brunei datevar) (line new_Timor datevar) /// 
 (line new_Malaysia datevar) (line new_Singapore datevar)  ///
(line new_Vietnam datevar)(line new_Indonesia datevar) (line new_Philippines datevar)

egen tot_death=rowtotal(new_Afghanistan- new_Zimbabwe)

twoway line  tot_death datevar
